...
#define SET_CCFG_SIZE_AND_DIS_FLAGS_DIS_ALT_DCDC_SETTING                       \
  0x0 // Alternative DC/DC setting enabled
// #define SET_CCFG_SIZE_AND_DIS_FLAGS_DIS_ALT_DCDC_SETTING 0x1    //
// Alternative DC/DC setting disabled
#endif
...
// #define SET_CCFG_SIZE_AND_DIS_FLAGS_DIS_XOSC_OVR     0x0        // Enable
// override
...
#define SET_CCFG_MODE_CONF_VDDR_TRIM_SLEEP_DELTA                               \
  0xF // Signed delta value +1 to apply to the VDDR_TRIM_SLEEP target
      // (0xF=-1=default=no compensation)
#endif

#ifndef SET_CCFG_MODE_CONF_DCDC_RECHARGE
#define SET_CCFG_MODE_CONF_DCDC_RECHARGE                                       \
  0x0 // Use the DC/DC during recharge in powerdown
// #define SET_CCFG_MODE_CONF_DCDC_RECHARGE             0x1        // Do not use
// the DC/DC during recharge in powerdown
#endif

#ifndef SET_CCFG_MODE_CONF_DCDC_ACTIVE
#define SET_CCFG_MODE_CONF_DCDC_ACTIVE 0x0 // Use the DC/DC during active mode
// #define SET_CCFG_MODE_CONF_DCDC_ACTIVE               0x1        // Do not use
// the DC/DC during active mode
#endif

#ifndef SET_CCFG_MODE_CONF_VDDS_BOD_LEVEL
// #define SET_CCFG_MODE_CONF_VDDS_BOD_LEVEL            0x0        // VDDS BOD
// level is 2.0V
#define SET_CCFG_MODE_CONF_VDDS_BOD_LEVEL                                      \
  0x1 // VDDS BOD level is 1.8V (or 1.65V for external regulator mode)
#endif

#ifndef SET_CCFG_MODE_CONF_VDDR_CAP
#define SET_CCFG_MODE_CONF_VDDR_CAP                                            \
  0x3A // Unsigned 8-bit integer representing the min. decoupling capacitance on
       // VDDR in units of 100nF
#endif

#ifndef SET_CCFG_MODE_CONF_VDDR_TRIM_SLEEP_TC
//#define SET_CCFG_MODE_CONF_VDDR_TRIM_SLEEP_TC           0x1        //
// Temperature compensation on VDDR sleep trim disabled (default)
#define SET_CCFG_MODE_CONF_VDDR_TRIM_SLEEP_TC                                  \
  0x0 // Temperature compensation on VDDR sleep trim enabled
#endif
...
// #define SET_CCFG_MODE_CONF_SCLK_LF_OPTION          0x0        // LF clock
// derived from High Frequency XOSC #define SET_CCFG_MODE_CONF_SCLK_LF_OPTION
// 0x1        // External LF clock
//#define SET_CCFG_MODE_CONF_SCLK_LF_OPTION           0x2        // LF XOSC
#define SET_CCFG_MODE_CONF_SCLK_LF_OPTION 0x3 // LF RCOSC
#endif

#ifndef SET_CCFG_MODE_CONF_XOSC_CAP_MOD
// #define SET_CCFG_MODE_CONF_XOSC_CAP_MOD              0x0        // Apply
// cap-array delta
...
#define SET_CCFG_MODE_CONF_XOSC_CAPARRAY_DELTA                                 \
  0xFF // Signed 8-bit value, directly modifying trimmed XOSC cap-array value
#endif
...
#define SET_CCFG_EXT_LF_CLK_RTC_INCREMENT                                      \
  0x800000 // RTC increment representing the external LF clock frequency
#endif
...
// #define SET_CCFG_MODE_CONF_XOSC_FREQ                 0x1        // Use HPOSC
// as HF source (if executing on a HPOSC chip, otherwise using default (=0x3))
// #define SET_CCFG_MODE_CONF_XOSC_FREQ                 0x2        // HF source
// is a 48 MHz xtal
...
// #define SET_CCFG_BL_CONFIG_BOOTLOADER_ENABLE         0xC5       // Enable ROM
// boot loader
#endif

#ifndef SET_CCFG_BL_CONFIG_BL_LEVEL
// #define SET_CCFG_BL_CONFIG_BL_LEVEL                  0x0        // Active low
// to open boot loader backdoor
#define SET_CCFG_BL_CONFIG_BL_LEVEL                                            \
  0x1 // Active high to open boot loader backdoor
#endif

#ifndef SET_CCFG_BL_CONFIG_BL_PIN_NUMBER
#define SET_CCFG_BL_CONFIG_BL_PIN_NUMBER                                       \
  0xFF // DIO number for boot loader backdoor
#endif
...
#define SET_CCFG_CCFG_TI_OPTIONS_TI_FA_ENABLE                                  \
  0x00 // Disable unlocking of TI FA option.
// #define SET_CCFG_CCFG_TI_OPTIONS_TI_FA_ENABLE        0xC5       // Enable
// unlocking of TI FA option with the unlock code
#endif

#ifndef SET_CCFG_CCFG_TAP_DAP_0_CPU_DAP_ENABLE
// #define SET_CCFG_CCFG_TAP_DAP_0_CPU_DAP_ENABLE       0x00       // Access
// disabled
#define SET_CCFG_CCFG_TAP_DAP_0_CPU_DAP_ENABLE                                 \
  0xC5 // Access enabled if also enabled in FCFG
#endif

#ifndef SET_CCFG_CCFG_TAP_DAP_0_PRCM_TAP_ENABLE
#define SET_CCFG_CCFG_TAP_DAP_0_PRCM_TAP_ENABLE 0x00 // Access disabled
// #define SET_CCFG_CCFG_TAP_DAP_0_PRCM_TAP_ENABLE      0xC5       // Access
// enabled if also enabled in FCFG
#endif

#ifndef SET_CCFG_CCFG_TAP_DAP_0_TEST_TAP_ENABLE
// #define SET_CCFG_CCFG_TAP_DAP_0_TEST_TAP_ENABLE      0x00       // Access
// disabled
#define SET_CCFG_CCFG_TAP_DAP_0_TEST_TAP_ENABLE                                \
  0xC5 // Access enabled if also enabled in FCFG
#endif

#ifndef SET_CCFG_CCFG_TAP_DAP_1_PBIST2_TAP_ENABLE
#define SET_CCFG_CCFG_TAP_DAP_1_PBIST2_TAP_ENABLE 0x00 // Access disabled
// #define SET_CCFG_CCFG_TAP_DAP_1_PBIST2_TAP_ENABLE    0xC5       // Access
// enabled if also enabled in FCFG
#endif

#ifndef SET_CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE
#define SET_CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE 0x00 // Access disabled
// #define SET_CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE    0xC5       // Access
// enabled if also enabled in FCFG
#endif

#ifndef SET_CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE
#define SET_CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE 0x00 // Access disabled
// #define SET_CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE       0xC5       // Access
// enabled if also enabled in FCFG
#endif
...
// #define SET_CCFG_ERASE_CONF_CHIP_ERASE_DIS_N         0x0        // Any chip
// erase request detected during boot will be ignored
#define SET_CCFG_ERASE_CONF_CHIP_ERASE_DIS_N                                   \
  0x1 // Any chip erase request detected during boot will be performed by the
      // boot FW
#endif

#ifndef SET_CCFG_ERASE_CONF_BANK_ERASE_DIS_N
// #define SET_CCFG_ERASE_CONF_BANK_ERASE_DIS_N         0x0        // Disable
// the boot loader bank erase function
#define SET_CCFG_ERASE_CONF_BANK_ERASE_DIS_N                                   \
  0x1 // Enable the boot loader bank erase function
#endif
...
// #define SET_CCFG_IMAGE_VALID_CONF_IMAGE_VALID        <non-zero> // Flash
// image is invalid, call bootloader
#endif
...
// #define SET_CCFG_SIZE_AND_DIS_FLAGS_DIS_GPRAM        0x0        // Cache is
// disabled and GPRAM is available at 0x11000000-0x11001FFF
#define SET_CCFG_SIZE_AND_DIS_FLAGS_DIS_GPRAM                                  \
  0x1 // Cache is enabled and GPRAM is disabled (unavailable)
#endif
...
#define DEFAULT_CCFG_MODE_CONF                                                 \
  ((((uint32_t)(SET_CCFG_MODE_CONF_VDDR_TRIM_SLEEP_DELTA                       \
   ...
   (((uint32_t)(SET_CCFG_MODE_CONF_VDDR_TRIM_SLEEP_TC                          \
                << CCFG_MODE_CONF_VDDR_TRIM_SLEEP_TC_S)) |                     \
    ~CCFG_MODE_CONF_VDDR_TRIM_SLEEP_TC_M) &                                    \
   (((uint32_t)(SET_CCFG_MODE_CONF_RTC_COMP << CCFG_MODE_CONF_RTC_COMP_S)) |   \
    ~CCFG_MODE_CONF_RTC_COMP_M) &                                              \
   (((uint32_t)(SET_CCFG_MODE_CONF_XOSC_FREQ << CCFG_MODE_CONF_XOSC_FREQ_S)) | \
    ~CCFG_MODE_CONF_XOSC_FREQ_M) &                                             \
   (((uint32_t)(SET_CCFG_MODE_CONF_XOSC_CAP_MOD                                \
                << CCFG_MODE_CONF_XOSC_CAP_MOD_S)) |                           \
    ~CCFG_MODE_CONF_XOSC_CAP_MOD_M) &                                          \
   (((uint32_t)(SET_CCFG_MODE_CONF_HF_COMP << CCFG_MODE_CONF_HF_COMP_S)) |     \
    ~CCFG_MODE_CONF_HF_COMP_M) &                                               \
   (((uint32_t)(SET_CCFG_MODE_CONF_XOSC_CAPARRAY_DELTA                         \
                << CCFG_MODE_CONF_XOSC_CAPARRAY_DELTA_S)) |                    \
    ~CCFG_MODE_CONF_XOSC_CAPARRAY_DELTA_M) &                                   \
   (((uint32_t)(SET_CCFG_MODE_CONF_VDDR_CAP << CCFG_MODE_CONF_VDDR_CAP_S)) |   \
...
#define DEFAULT_CCFG_VOLT_LOAD_0                                               \
  ((((uint32_t)(SET_CCFG_VOLT_LOAD_0_VDDR_EXT_TP45                             \
   ...
   (((uint32_t)(SET_CCFG_VOLT_LOAD_0_VDDR_EXT_TP25                             \
                << CCFG_VOLT_LOAD_0_VDDR_EXT_TP25_S)) |                        \
    ~CCFG_VOLT_LOAD_0_VDDR_EXT_TP25_M) &                                       \
   (((uint32_t)(SET_CCFG_VOLT_LOAD_0_VDDR_EXT_TP5                              \
                << CCFG_VOLT_LOAD_0_VDDR_EXT_TP5_S)) |                         \
    ~CCFG_VOLT_LOAD_0_VDDR_EXT_TP5_M) &                                        \
   (((uint32_t)(SET_CCFG_VOLT_LOAD_0_VDDR_EXT_TM15                             \
                << CCFG_VOLT_LOAD_0_VDDR_EXT_TM15_S)) |                        \
    ~CCFG_VOLT_LOAD_0_VDDR_EXT_TM15_M))

#define DEFAULT_CCFG_VOLT_LOAD_1                                               \
  ((((uint32_t)(SET_CCFG_VOLT_LOAD_1_VDDR_EXT_TP125                            \
                << CCFG_VOLT_LOAD_1_VDDR_EXT_TP125_S)) |                       \
    ~CCFG_VOLT_LOAD_1_VDDR_EXT_TP125_M) &                                      \
   (((uint32_t)(SET_CCFG_VOLT_LOAD_1_VDDR_EXT_TP105                            \
                << CCFG_VOLT_LOAD_1_VDDR_EXT_TP105_S)) |                       \
    ~CCFG_VOLT_LOAD_1_VDDR_EXT_TP105_M) &                                      \
   (((uint32_t)(SET_CCFG_VOLT_LOAD_1_VDDR_EXT_TP85                             \
                << CCFG_VOLT_LOAD_1_VDDR_EXT_TP85_S)) |                        \
    ~CCFG_VOLT_LOAD_1_VDDR_EXT_TP85_M) &                                       \
   (((uint32_t)(SET_CCFG_VOLT_LOAD_1_VDDR_EXT_TP65                             \
                << CCFG_VOLT_LOAD_1_VDDR_EXT_TP65_S)) |                        \
    ~CCFG_VOLT_LOAD_1_VDDR_EXT_TP65_M))

#define DEFAULT_CCFG_RTC_OFFSET                                                \
  ((((uint32_t)(SET_CCFG_RTC_OFFSET_RTC_COMP_P0                                \
                << CCFG_RTC_OFFSET_RTC_COMP_P0_S)) |                           \
    ~CCFG_RTC_OFFSET_RTC_COMP_P0_M) &                                          \
   (((uint32_t)(SET_CCFG_RTC_OFFSET_RTC_COMP_P1                                \
                << CCFG_RTC_OFFSET_RTC_COMP_P1_S)) |                           \
    ~CCFG_RTC_OFFSET_RTC_COMP_P1_M) &                                          \
   (((uint32_t)(SET_CCFG_RTC_OFFSET_RTC_COMP_P2                                \
                << CCFG_RTC_OFFSET_RTC_COMP_P2_S)) |                           \
    ~CCFG_RTC_OFFSET_RTC_COMP_P2_M))

#define DEFAULT_CCFG_FREQ_OFFSET                                               \
  ((((uint32_t)(SET_CCFG_FREQ_OFFSET_HF_COMP_P0                                \
                << CCFG_FREQ_OFFSET_HF_COMP_P0_S)) |                           \
    ~CCFG_FREQ_OFFSET_HF_COMP_P0_M) &                                          \
   (((uint32_t)(SET_CCFG_FREQ_OFFSET_HF_COMP_P1                                \
                << CCFG_FREQ_OFFSET_HF_COMP_P1_S)) |                           \
    ~CCFG_FREQ_OFFSET_HF_COMP_P1_M) &                                          \
   (((uint32_t)(SET_CCFG_FREQ_OFFSET_HF_COMP_P2                                \
                << CCFG_FREQ_OFFSET_HF_COMP_P2_S)) |                           \
...
#define DEFAULT_CCFG_CCFG_TAP_DAP_1                                            \
  ((((uint32_t)(SET_CCFG_CCFG_TAP_DAP_1_PBIST2_TAP_ENABLE                      \
   ...
   (((uint32_t)(SET_CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE                      \
                << CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE_S)) |                 \
    ~CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE_M) &                                \
   (((uint32_t)(SET_CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE                         \
                << CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE_S)) |                    \
...
#define DEFAULT_CCFG_CCFG_TAP_DAP_1                                            \
  ((((uint32_t)(SET_CCFG_CCFG_TAP_DAP_1_PBIST2_TAP_ENABLE                      \
   ...
   (((uint32_t)(SET_CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE                      \
    ...
    ~CCFG_CCFG_TAP_DAP_1_PBIST1_TAP_ENABLE_M) &                                \
   (((uint32_t)(SET_CCFG_CCFG_TAP_DAP_1_WUC_TAP_ENABLE                         \
                << CCFG_CCFG_TAP_DAP_1_AON_TAP_ENABLE_S)) |                    \
    ~CCFG_CCFG_TAP_DAP_1_AON_TAP_ENABLE_M))
#endif // !defined(CC26X2)

#define DEFAULT_CCFG_IMAGE_VALID_CONF                                          \
  ((((uint32_t)(SET_CCFG_IMAGE_VALID_CONF_IMAGE_VALID                          \
...
const ccfg_t __ccfg __attribute__((section(".ccfg"))) __attribute__((used)) =
#endif
    {
        ...
        DEFAULT_CCFG_SIZE_AND_DIS_FLAGS, // 0x50003FB0  Independent of FLASH
                                         // size)
