...
CONST uint8 devInfoServUUID[ATT_BT_UUID_SIZE] = {LO_UINT16(DEVINFO_SERV_UUID),
                                                 HI_UINT16(DEVINFO_SERV_UUID)};

// System ID
CONST uint8 devInfoSystemIdUUID[ATT_BT_UUID_SIZE] = {LO_UINT16(SYSTEM_ID_UUID),
                                                     HI_UINT16(SYSTEM_ID_UUID)};
...
// PnP ID
CONST uint8 devInfoPnpIdUUID[ATT_BT_UUID_SIZE] = {LO_UINT16(PNP_ID_UUID),
                                                  HI_UINT16(PNP_ID_UUID)};
...
static CONST gattAttrType_t devInfoService = {ATT_BT_UUID_SIZE,
                                              devInfoServUUID};
...
static uint8 devInfoPnpId[DEVINFO_PNP_ID_LEN] = {
    ...
    LO_UINT16(0x000D),
    HI_UINT16(0x000D), // Vendor ID (Texas Instruments)
    LO_UINT16(0x0000),
