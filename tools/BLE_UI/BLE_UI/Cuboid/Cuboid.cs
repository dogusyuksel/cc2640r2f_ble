...
namespace BLE_UI.Cuboid
{
    public partial class Cuboid : Form
    {
        ...
        /// <summary>
        /// Gets or sets a value describing the camera view of the cuboid. See Cuboid.CameraViews.
        /// </summary>
        ...
        /// </summary>
        public Cuboid()
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, new float[] { 6, 4, 2 }, CameraViews.Front, 50.0f)
        {
        }
        ...
        /// </param>
        public Cuboid(string[] imageFilePaths)
        ...
        /// </param>
        public Cuboid(string[] imageFilePaths, float[] dimensions)
        ...
        /// </param>
        public Cuboid(string[] imageFilePaths, float[] dimensions, CameraViews cameraView)
        ...
        /// Value describing the camera view of the cuboid.
        /// </param>
        public Cuboid(string[] imageFilePaths, CameraViews cameraView)
        ...
        /// </param>
        public Cuboid(string[] imageFilePaths, CameraViews cameraView, float cameraDistance)
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public Cuboid(string[] imageFilePaths, float cameraDistance)
        ...
        public Cuboid(float[] dimensions)
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, dimensions, CameraViews.Front, 50.0f)
        {
        }
        ...
        /// Value describing the camera view of the cuboid.
        /// </param>
        public Cuboid(float[] dimensions, CameraViews cameraView)
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, dimensions, cameraView, 50.0f)
        {
        }
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public Cuboid(float[] dimensions, CameraViews cameraView, float cameraDistance)
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, dimensions, cameraView, cameraDistance)
        {
        }
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public Cuboid(float[] dimensions, float cameraDistance)
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, dimensions, CameraViews.Front, cameraDistance)
        {
        }
        ...
        /// Value describing the camera view of the cuboid.
        /// </param>
        public Cuboid(CameraViews cameraView)
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, new float[] { 6, 4, 2 }, cameraView, 50.0f)
        {
        }
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public Cuboid(CameraViews cameraView, float cameraDistance)
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, new float[] { 6, 4, 2 }, cameraView, cameraDistance)
        {
        }
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public Cuboid(float cameraDistance)
            : this(new string[] { "Cuboid/Right.png", "Cuboid/Left.png", "Cuboid/Back.png", "Cuboid/Front.png", "Cuboid/Top.png", "Cuboid/Bottom.png" }, new float[] { 6, 4, 2 }, CameraViews.Front, cameraDistance)
        {
        }
        ...
        /// Distance of the camera from the world origin.
        /// </param>
        public Cuboid(string[] imageFilePaths, float[] dimensions, CameraViews cameraView, float cameraDistance)
        {
            InitializeComponent();
        ...
        /// </summary>
        private void Cuboid_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
        ...
        /// </summary>
        private void Cuboid_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void formUpdateTimer_Tick(object sender, EventArgs e)
        {
            lock (this)
            {
                ...
                if (BLE_UI.Cuboid_Transparent)
                {
                    simpleOpenGlControl.Visible = false;             
                }
                else
                {
                    simpleOpenGlControl.Visible = true;
                }
            }
        }
